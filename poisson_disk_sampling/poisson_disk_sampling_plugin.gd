...
func _enter_tree():
	...
	add_custom_type("PoissonDiskSampler", "Object", preload("src/poisson_disk_sampling.gd"), preload("poisson.png"))
	# Create PoissionDiskSample2D node type.
	add_custom_type("PoissonDiskSampler2D", "Node2D", preload("src/poisson_disk_sampling_node.gd"), preload("poisson.png"))
